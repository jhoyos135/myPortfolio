...
export const data = [
    ...
    { id: 2, section: 'projects', route: 'home', color: '#A4CBB0', frontText: 'PROJECTS', backText: 'Take a look at some of my selected projects' },
    ...
    { id: 4, section: 'playground', route: 'home', color: '#F4B02A', background: getImage('playground'), frontText: 'PLAYGROUND', backText: 'A collection of front-end coding. These are a mix of features from previous work, practice and side projects.' },
    { id: 5, section: 'contact', route: 'home', color: '#471D5D', frontText: 'CONTACT', backText: 'Can\'t wait to hear from you' }
];
